...
declare
  ...
  i int;
  names text[] := array[
    'Parafusadeira de Impacto 21V','Conjunto de Ferramentas 108 peças','Jogo de Chaves Catraca','Alicate Universal Profissional','Furadeira de Impacto 650W','Serra Mármore 1300W','Esmerilhadeira Angular 850W','Trena Digital por Luz 40m','Medidor Digital Profissional','Multímetro Digital Automático',
    'Paquímetro Digital 150mm','Nível de Luz 12 Linhas','Balança Digital de Precisão','Termômetro Infravermelho','Organizador Modular 24 gavetas','Caixa Organizadora Empilhável','Estante Multiuso Reforçada','Maleta para Ferramentas 18 pol.','Painel Organizador Perfurado','Gaveteiro Plástico 12 Gavetas',
    'Leitor Automotivo sem Fio','Compressor de Ar Portátil','Carregador de Bateria 12V','Conjunto para Limpeza Automotiva','Câmera de Ré em Alta Definição','Suporte Veicular Magnético','Inflador Digital de Pneus','Cabo Auxiliar de Partida','Lanterna Recarregável','Mangueira Expansível 15m',
    'Pulverizador Manual 5L','Conjunto de Irrigação por Gotejamento','Luminária Solar de Parede','Fechadura Digital Biométrica','Sensor de Presença sem Fio','Câmera sem Fio em Alta Definição','Tomada Inteligente sem Fio','Adaptador de Conexões 7 em 1','Carregador Rápido 65W','Suporte Articulado para Monitor',
    'Teclado Mecânico Compacto','Dispositivo Apontador sem Fio','Fone sem Fio com Microfone','Mochila para Computador Portátil 17 pol.','Bolsa Térmica 20 Litros','Garrafa Térmica de Aço 1L','Cinta Ergonômica Lombar','Óculos de Proteção Antiembaçante','Luva Anticorte Nível 5','Protetor Auricular Tipo Concha'
  ];
...
begin
  ...
  delete from public.suppliers where user_id=v_user and name in ('Atlas Distribuidora','Norte Ferramentas','Vetor Imports','Vetor Importações','Orbital Atacado','Ponto Smart Distribuição','Ponto Inteligente Distribuição');
  ...
  insert into public.suppliers(user_id,name,contact,city,state,lead_time_days,notes) values
    ...
    (v_user,'Vetor Importações','Bianca Lima','Curitiba','PR',9,'FORNECEDOR FICTÍCIO'),
    (v_user,'Orbital Atacado','Lucas Mendes','Joinville','SC',7,'FORNECEDOR FICTÍCIO'),
    (v_user,'Ponto Inteligente Distribuição','Aline Rocha','São Paulo','SP',3,'FORNECEDOR FICTÍCIO');
